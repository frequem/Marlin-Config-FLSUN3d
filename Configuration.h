...
#define STRING_CONFIG_H_AUTHOR "(frequem, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FLSUN3D Delta Kossel"
...
#define DELTA
  ...
  #define DELTA_EFFECTOR_OFFSET 25.0 // mm, updated

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 32.0 // mm, updated
...
#define MANUAL_Z_HOME_POS 285 // Distance between the nozzle to printbed after homing
